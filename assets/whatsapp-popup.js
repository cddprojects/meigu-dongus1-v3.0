(function () {
  ...
  if (document.querySelector("[data-hz-whatsapp]")) return;

  var wrap = document.createElement("div");
  wrap.className = "hz-whatsapp";
  wrap.setAttribute("data-hz-whatsapp", "");
  wrap.innerHTML = [
    '<a class="hz-whatsapp__trigger" href="' + WA_HREF + '" target="_blank" rel="noopener noreferrer" aria-label="Chat with us on WhatsApp">',
    ...
    '<span class="hz-whatsapp__trigger-label">WhatsApp us</span></a>'
  ].join("");
