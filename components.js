...
(function () {
  ...
  function navHtml() {
    return ''
      ...
      +       '<img src="logo.png" alt="The Daily Watchlist" height="32" width="auto" loading="eager"'
      +         ' onerror="this.style.display=\'none\';this.nextElementSibling.style.display=\'flex\';" />'
      +       '<span style="display:none;font-family:\'Lora\',serif;font-weight:700;font-size:1rem;color:var(--text);">The Daily Watchlist</span>'
      +     '</a>'
